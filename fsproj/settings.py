...
SECRET_KEY = 'django-insecure-@q@+k(e55(r4n%*a!9d0uj618pmm8498dy@!$!hpxou_2ij5)+'
...
WSGI_APPLICATION = 'fsproj.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    #'PAGE_SIZE': 4, #Overriden to be dynamic by user query-param
